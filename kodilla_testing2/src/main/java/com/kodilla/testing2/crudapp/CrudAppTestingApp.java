...
public class CrudAppTestingApp {
    ...
    public static final String XPATH_WAITING_FOR = "//select[1]";
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://marrucha.github.io");

        WebElement searchField = driver.findElement(By.xpath(XPATH_INPUT));
        searchField.sendKeys("New robotic task");
        WebElement textAreaField2 = driver.findElement(By.xpath(XPATH_TEXTAREA));
        textAreaField2.sendKeys("New robotic task desc");
